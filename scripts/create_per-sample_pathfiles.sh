...
hitmap=dk_scores/hiv_0.75_hidden_by_sample.tab
...
labels=data/hiv_human_master_labels.tab

# Files produced by Java: full path info and subgraph info.
paths=data/hiv_len3_master_paths.tab
subgraphs=data/hiv_len3_master_subgraphs.tab
