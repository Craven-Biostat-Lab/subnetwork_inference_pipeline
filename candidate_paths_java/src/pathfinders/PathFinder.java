...
public abstract class PathFinder {
	 ...
	 * For each starting point, searches for paths up to "addDepth" edges 
	 * longer than originally requested. 
	 * "stop" is a stopping condition given to the instance of the pathfinder. 
	 * 
	 * @param g
	 * @param addDepth
	 * @param stop
	 * @return
	 */
	public abstract PathManager findPathsIterative(Graph g, int addDepth, double stop);
