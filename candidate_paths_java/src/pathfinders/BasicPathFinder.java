 ...
 * By default, search stops at the first accepted end node. However, we can tell the PathFinder to operate in "save and continue"
 * mode so that multiple endpoints can appear in the path.
 * 
