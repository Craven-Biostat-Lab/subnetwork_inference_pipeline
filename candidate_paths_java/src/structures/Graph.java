...
//		}	
	...
	public static Graph createFromEdgeLibrary(EdgeLibrary el)
		...
		// make sure that connections between nodes are unique
		//boolean uniq = el.verifyNoDuplicates();
		//if (!uniq) throw new DuplicateException("EdgeLibrary contains duplicate edges.");
